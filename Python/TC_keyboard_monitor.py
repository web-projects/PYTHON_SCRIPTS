...
def getSignature():
   ...
   #
   # putfile.py --file upload/html/signature_keyPress.html --rfile www/mapp/signature.html
   # getfile.py --file www/mapp/signature.html --lfile signature.html --serial COM30
   
   ''' html resource data '''
   keyboard_file = b'mapp/kbd_monitor.html'
   signature_message = b'ENTER SIGNATURE'
   signature_logo = b'signature.png'
   signature_tags = [
      [ (0xDF, 0xAA, 0x01), keyboard_file ],
