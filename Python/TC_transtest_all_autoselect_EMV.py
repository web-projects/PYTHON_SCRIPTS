...
def processEMV(tid):
    ...
    continue_tran_tag = [
        ...
        [ (0x8A), [0x5A,0x33] ],  # authorization response code
    ...
    # REQUEST PIN ENTRY
    log.log('EMV REQUEST PIN ENTRY ******************************************* ')
    conn.send([0xDE, (0xD6 if args.online else 0xD2), 0x02, 0x00], continue_tpl)
...
if __name__ == '__main__':
    ...
    arg.add_argument( '--custid', dest='custid', default='1117600', type=int,
                            help='TC CustID for transaction' )
    arg.add_argument( '--password', dest='password', default='ipa1234',
    ...
    arg.add_argument( '--online', dest= 'online', default=False, type=bool,
                            help='Online PIN')
