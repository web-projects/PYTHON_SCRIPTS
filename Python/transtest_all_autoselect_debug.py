...
def processTransaction():
    ...
    if (cardState != EMV_CARD_INSERTED):
        if (ctls):
            ...
            start_ctls_tag = [
                ## TRANSACTION AMOUNT
                #[(0x9F, 0x02), b'\x00\x00\x00\x00\x21\x09' ],
                #[(0x9F, 0x02), b'\x00\x00\x00\x00\x09\x01' ],
                #[(0x9F, 0x02), b'\x00\x00\x00\x01\x15\x01' ],
                #[(0x9F, 0x02), b'\x00\x00\x00\x02\x00\x02' ],   # COLLIS VISA TEST CASE 02
                #[(0x9F, 0x02), b'\x00\x00\x00\x00\x06\x06' ],   # COLLIS VISA TEST CASE 06
                [(0x9F, 0x02), b'\x00\x00\x00\x00\x02\x00' ],   # COLLIS DISCOVER TEST CASE E2E CL 36
                [(0x9A), b'\x20\x03\x23'],
                [(0x9C), b'\x00'],
