...
commands = [
    ...
    ([0xD2, 0x01, 0x10, 0x01], "Display Processing Complete", 3),
    ([0xD2, 0x01, 0x13, 0x01], "Display Insert Card", 3),
    ([0xD2, 0x01, 0x14, 0x01], "Display Remove Card", 3),
    ([0xD2, 0x01, 0x20, 0x01], "Network cable disconnected", 3),
    ([0xD2, 0x01, 0x01, 0x01], "Reset display", 0),
]
...
def demo_function():
    ...
    conn.send([0xD2, 0x01, 0x02, 0x01], "Processing Transaction")
