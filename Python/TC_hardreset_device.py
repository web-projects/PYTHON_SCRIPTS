...
def processReset():
    ...
    #Extended reset command: bits 10 and 11 set
    config_reload_tag = [
        [ (0xDF,0xED, 0x0D), [0x00, 0x06, 0x00, 0x00 ] ]
    ]
    config_reload_tpl = (0xE0, config_reload_tag )
    #Send reset device
    conn.send([0xD0, 0x0A, 0x00, 0x01], config_reload_tpl)
