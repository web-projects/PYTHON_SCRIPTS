...
def processRequest():
   ...
   text_style_0 = b'style=\"text-align:center; font-size: 24px;\"'
   message_0 = b'MESSAGE LINE 1'
   ...
   ''' html resource data '''
   html_file = b'mapp/display.html'
   html_tags = [
      [(0xDF, 0xAA, 0x01), html_file],
      [(0xDF, 0xAA, 0x02), b'TEMPLATE_VAR0'], [(0xDF, 0xAA, 0x03), text_style_0],
      [(0xDF, 0xAA, 0x02), b'TEMPLATE_VAR1'], [(0xDF, 0xAA, 0x03), message_0],
